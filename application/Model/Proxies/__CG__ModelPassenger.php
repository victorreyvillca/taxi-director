 ...
 */
class Passenger extends \Model\Passenger implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'address', 'description', 'id', 'created', 'changed', 'createdBy', 'changedBy', 'state');
        }
