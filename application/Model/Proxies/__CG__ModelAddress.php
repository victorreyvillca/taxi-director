 ...
 */
class Address extends \Model\Address implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'labelId', 'label', 'passengerId', 'passenger', 'id', 'created', 'changed', 'createdBy', 'changedBy', 'state');
        }
