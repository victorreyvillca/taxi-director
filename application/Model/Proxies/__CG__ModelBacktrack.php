 ...
 */
class Backtrack extends \Model\Backtrack implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'status', 'taxiId', 'taxi', 'latitud', 'longitud', 'timenow', 'id', 'created', 'changed', 'createdBy', 'changedBy', 'state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Backtrack $proxy) {
    ...
    public function getTimenow()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTimenow', array());

        return parent::getTimenow();
    }
    ...
    public function setTimenow($timenow)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTimenow', array($timenow));

        return parent::setTimenow($timenow);
    }
