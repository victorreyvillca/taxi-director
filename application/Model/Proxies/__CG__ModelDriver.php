 ...
 */
class Driver extends \Model\Driver implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'address', 'note', 'id', 'created', 'changed', 'createdBy', 'changedBy', 'state');
        }
